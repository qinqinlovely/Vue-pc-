...
-- --面板切换
-- 评价香水
INSERT INTO `mysc_detail` VALUES ('13', '3', ' Chopard 萧邦 愿望之光蓝钻女士香水 EDP 75ml','xiaobang-lg.jpg','xiaobang-sm.jpg','22.39', '69.00', '152.52', '3.2', 'Chopard 萧邦 愿望之光蓝钻女士香水（EDP） 运用了特殊的原料来丰富主题，随着透明纯净的克里门汀草、香味扑鼻的柚子，及苦中带甜的醋栗，传递出新鲜花香的最初诱惑。接续而来的野百合、娇嫩的樱草花，在辛辣味的粉红胡椒和香甜多汁的梨子突显下，更添清新芬芳，春意盎然。 后味鲜丽的薄荷花使得木质温润气息更加浓郁，而融入细腻滑润的香草使感觉更为愉悦畅快，就像流星画过午夜的天空，Wish香水留下耀眼的光芒。', 'Chopard 萧邦', '愿望之光蓝钻女士香水', '75ml', 'EDP/香水', '适合所有女士使用。', '东方美食调', '忍冬、草莓、洋槐、橙花、椰子、醋栗 、巴西红木、梨、黑加仑、樱草。 ', '蜂蜜、紫罗兰、兰花、牛奶、天芥菜、铃兰、茉莉、木兰、桂花。', '檀香木、琥珀、广藿香、香草、焦糖、焚香、零陵香豆、太妃糖。','浅蓝色的香氛在透明的玻璃瓶中，外盒则是恍如夜空般的深蓝，让Wish显得更为晶莹剔透。','携带使用简单、快捷，香氛宜人，轻松应付各种社交场合。','经检验，无添加任何人工色素、矿物油、防腐剂。','1860年，路易于利斯·萧邦在瑞士汝拉山松维裹埃小乡村创立了萧邦，萧邦专业生产怀表和精密时计。萧邦的钟表制作工艺超卓，在金质的怀表中享有杰出的声望。','','','','');
